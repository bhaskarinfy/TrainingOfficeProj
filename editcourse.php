...
echo "courseid is ".$course_id;
$sql = "SELECT course_id,course_name, course_content, course_description FROM coursemst where course_id=$course_id";
...
echo "<html> <head></head><body><form method=post action=updatecourse.php>  <input  name= 'course_id' type='hidden' value='$course_id'><input  name= 'course_name' type='text' value='$coursename'><input  name= 'course_content' type='text' value='$coursecontent'><input  name= 'course_description' type='text' value='$coursedescription'><input type='submit' value='Update'> </form>" ;
//echo $_GET["sno"];
//echo $coursename;
